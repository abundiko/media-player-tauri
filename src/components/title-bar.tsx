...
import { LuMinimize, LuMaximize, LuMinimize2, LuX } from 'react-icons/lu'
...
export function TitleBar() {
  ...
  return (
    <div
      ...
      className="flex h-9 shrink-0 items-center justify-between border-b border-border bg-surface px-3 select-none"
    >
      <span className="text-xs font-medium text-text-muted">Media Player</span>
